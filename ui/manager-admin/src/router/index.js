...
const disRouterMap = {
  ...
  children: [
    ...
    { path: 'bill-list/:id', component: () => import('@/views/distribution/achievement/billList'), name: 'billList', meta: { title: 'billList' }, hidden: true },
...
const asyncRouters = [
  ...
  // 订单管理
  {
    ...
    children: [
      ...
      { path: 'receipt-examine', component: () => import('@/views/order/receiptExamine'), name: 'receiptExamine', meta: { title: 'receiptExamine' }},
      ...
      { path: 'service-detail/:service_sn', component: () => import('@/views/order/serviceDetail'), name: 'serviceDetail', hidden: true, meta: { title: 'serviceDetail' }}
    ]
  },
  // 会员管理
  {
    ...
    children: [
      ...
      {
        path: '/member/pre-deposit',
        component: () => import('@/views/member/pre-deposit/index'),
        redirect: '/member/pre-deposit/rechargeList',
        name: 'preDeposit',
        meta: { title: 'preDeposit' },
        children: [
          { path: 'rechargeList', component: () => import('@/views/member/pre-deposit/rechargeList'), name: 'rechargeList', meta: { title: 'rechargeList' }},
          { path: 'preDepositDetail', component: () => import('@/views/member/pre-deposit/preDepositDetail'), name: 'preDepositDetail', meta: { title: 'preDepositDetail' }}
        ]
      },
  ...
  // 促销管理
  {
    ...
    children: [
      ...
      { path: 'coupon/:id', component: () => import('@/views/promotions/coupon-manage/coupon'), name: 'couponUpdate', meta: { title: 'couponUpdate' }, hidden: true },
  ...
  // 设置
  {
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          { path: 'shop', component: () => import('@/views/setting/message-settings/shopMessage'), name: 'shopMessage', meta: { title: 'shopMessage' }},
          { path: 'member', component: () => import('@/views/setting/message-settings/memberMessage'), name: 'memberMessage', meta: { title: 'memberMessage' }},
  ...
  // 开发
  {
    ...
    children: [
      ...
      {
        path: '/development/log-analysis',
        component: () => import('@/views/development/log-analysis/index'),
        redirect: '/development/log-analysis/log-list',
        name: 'logAnalysis',
        meta: { title: 'logAnalysis' },
        children: [
          { path: 'log-list', component: () => import('@/views/development/log-analysis/log-list'), name: 'logList', meta: { title: 'logList' }},
          { path: 'log-detail', component: () => import('@/views/development/log-analysis/log-detail'), name: 'logDetails', meta: { title: 'logDetails' }}
        ]
      }
    ]
  },
