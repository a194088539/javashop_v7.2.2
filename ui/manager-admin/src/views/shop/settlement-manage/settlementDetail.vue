  ...
  <div class="refund-detail-container">
    <el-card v-if="settlement">
      ...
      <el-row :gutter="0">
        ...
        <el-col :span="4">分销退还佣金总金额</el-col>
        <el-col :span="8">￥{{ settlement.distribution_return_rebate | unitPrice }}</el-col>
      </el-row>
      <el-row :gutter="0">
        <el-col :span="4">用户使用平台优惠券总金额</el-col>
        <el-col :span="20">{{ settlement.site_coupon_commi | unitPrice }}</el-col>
      </el-row>
      <el-row :gutter="0">
        ...
        <el-col :span="20">
          ...
          <em class="plus"> + ￥{{ settlement.distribution_return_rebate | unitPrice }}</em>(分销退还佣金总金额)
          <em class="plus"> + ￥{{ settlement.site_coupon_commi | unitPrice }}</em>(用户使用平台优惠券总金额)
