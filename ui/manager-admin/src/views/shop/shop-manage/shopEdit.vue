<template>
  <div v-loading="loading">
    <el-form :model="shopForm" :rules="shopRules" ref="shopForm" inline label-width="135px">
      <el-tabs type="border-card" v-model="tableName" ref="tabs">
        <el-tab-pane label="基本信息" name="base">
          ...
          <el-form-item label="注册资金" prop="reg_money">
            <el-input v-model="shopForm.reg_money" :maxlength="10">
...
<!--        </el-tab-pane>-->
        <el-tab-pane label="开户行银行许可证" name="bank">
          ...
          <el-form-item label="公司银行账号" prop="bank_number">
            <el-input v-model="shopForm.bank_number" :maxlength="45"></el-input>
          </el-form-item>
        ...
        <el-tab-pane label="店铺信息" name="shop">
          <el-form-item label="店铺名称" prop="shop_name">
            <el-input v-model="shopForm.shop_name" :maxlength="15"></el-input>
          </el-form-item>
          ...
          <el-form-item label="店铺详细地址" prop="shop_add">
            <el-input v-model="shopForm.shop_add" :maxlength="50"></el-input>
          </el-form-item>
        </el-tab-pane>
          ...
          company_phone: [
            ...
            { validator: (rule, value, callback) => {
              if (RegExp.mobile.test(value) || RegExp.TEL.test(value)) {
                ...
                callback(new Error('请输入正确的手机号或者固定电话 例:010-8888888'))
              }
            },
            trigger: 'blur'
            }
          ...
          if (valid) {
            ...
            API_Shop.editAuthShop(this.shop_id, params).then(response => {
              if (this.isAudit) {
                ...
                this.$router.push({ path: '/shop/shop-manage/shop-list' })
                _params.callback()
                console.log(_params)
              } else {
