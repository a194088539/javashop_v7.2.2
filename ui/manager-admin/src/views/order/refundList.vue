  ...
  <div>
    <en-table-layout
      ...
      <template slot="table-columns">
        ...
        <!--商家同意的退款金额-->
        <el-table-column prop="agree_price" label="同意退款金额"/>
        <!--实际退款金额-->
        <el-table-column prop="actual_price" label="实际退款金额"/>
        <!--状态-->
