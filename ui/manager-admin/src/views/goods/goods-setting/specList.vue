<template>
  <div>
    ...
    >
      <div slot="toolbar" class="inner-toolbar">
        ...
        <div class="toolbar-search">
          <en-table-search @search="searchEvent" placeholder="请输入规格名称"/>
        </div>
      </div>
        ...
        <el-table-column label="操作" width="350">
          <template slot-scope="scope">
            <el-button
              size="mini"
              type="primary"
              @click="handleEditSpec(scope.$index, scope.row)">编辑规格</el-button>
            <el-button
              size="mini"
              type="primary"
              @click="handleEditSpecVal(scope.$index, scope.row)">编辑规格值</el-button>
            <el-button
              size="mini"
              type="danger"
    ...
    >
      ...
      />
      <p style="color:#666;font-size:12px;">规格值不可重复</p>
      <span slot="footer" class="dialog-footer">
