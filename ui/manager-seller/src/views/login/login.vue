        ...
        <div class="lf-form" @keyup.enter="submitLoginForm">
          <el-form :model="loginForm" :rules="loginRules" ref="loginForm" size="large" label-width="80px">
            ...
            <el-form-item label="登录密码" prop="password">
              <el-input v-model="loginForm.password" type="password" autocompete="off" clearable placeholder="请输入密码" maxlength="20"></el-input>
            </el-form-item>
            ...
            <div v-else></div>
            <el-form-item>
              <el-button type="primary" :loading="loading" :disabled="!accountAfsSuccess" @click="submitLoginForm" class="login-btn">确认登录</el-button>
            </el-form-item>
          </el-form>
        </div>
      </div>
      <div class="lf-register">
        还没有成为我们的合作伙伴？<a :href="MixinBuyerDomain + '/register?forward=/shop/apply'">快速注册</a>
      </div>
    </div>
  </div>
</template>
