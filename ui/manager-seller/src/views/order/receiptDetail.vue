    ...
    <div class="receipt-information">
      ...
      <template v-if="receiptDetail.receipt_type === 'ELECTRO'">
        <ul>
          ...
          <li v-if="receiptDetail.status === 1">电子发票：<a style="cursor: pointer;" :href="this.receiptDetail.elec_file_list[0]">点击下载</a></li>
    ...
    <el-dialog :visible.sync="logisticsShow" width="400px" align="center">
      <div slot="title">
        ...
        <div class="logistics-base">
          <span>物流公司：{{ this.receiptDetail.logi_name }}</span>
          <span>快递单号：{{ this.receiptDetail.logi_code }}</span>
        </div>
      </div>
