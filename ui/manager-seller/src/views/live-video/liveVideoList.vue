  ...
  <div>
    ...
    >
      ...
      <template slot="table-columns">
        ...
        <!--直播时间-->
        <el-table-column label="直播时间" width="350">
          <template slot-scope="scope">
      ...
      <el-form :model="liveVideoData" label-position="right" ref="liveVideoData" label-width="130px" :rules="rules" status-icon>
        ...
        <el-form-item label="直播间背景图：" prop="background_image_url">
          <el-upload
            ...
            :on-success="(res) => { liveVideoData.background_image = res.media_id; liveVideoData.background_image_url = res.url }"
        ...
        <el-form-item label="直播间分享图：" prop="share_img_url">
          <el-upload
            ...
            :on-success="(res) => { liveVideoData.share_img = res.media_id; liveVideoData.share_img_url = res.url }"
            :on-exceed="() => { $message.error('文件数量超过限制！') }">
            <i class="el-icon-plus avatar-uploader-icon"></i>
