        ...
        <div class="base-info-item">
          ...
          <div>
            <el-form-item label="商品名称：" prop="goods_name" class="goods-name-width">
              <el-input v-model="baseInfoForm.goods_name" @change="() => { baseInfoForm.goods_name = baseInfoForm.goods_name.trim() }" :maxlength="30" :minlength="3" placeholder="3-30个字符"></el-input>
            </el-form-item>
            ...
            <el-form-item label="商品图片：" ref="goods_gallery" prop="goods_gallery" style="width: 90%;text-align: left;">
              <upload-sortable
            ...
            <el-form-item label="商品视频：" style="width: 90%;text-align: left;">
              <div class="avatar" v-if="baseInfoForm.goods_video">
                <video 
                  :src="baseInfoForm.goods_video"
                  class="video-avatar"
                  autoplay="autoplay"
                  controls="controls">
                    您的浏览器不支持视频播放
              ...
              >
                <i v-if="!baseInfoForm.goods_video && !videoFlag" class="el-icon-plus avatar-uploader-icon"></i>
                <el-progress v-if="videoFlag"
                   type="circle"
                   :percentage="videoUploadPercent"
                   style="margin-top:7px;">
                </el-progress>
                <span v-if="videoErrorTip" class="error" style="font-size: 12px;color:#f56c6c;">(视频上传失败，请重新上传！)</span>
                <div slot="tip" class="el-upload__tip">最多可以上传1个视频，建议大小10M，推荐格式mp4</div>
              </el-upload>
            </el-form-item>
          </div>
        </div>
    ...
    <div class="content-goods-publish" v-if="activestep === 2">
      <el-form
        ...
        <el-form-item label="移动端描述：" class="goods-intro">
          <EditArea
            :mobileDescriptionList="baseInfoForm.intro_list"
