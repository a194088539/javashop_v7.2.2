 ...
 * 创建订单
 */
export function createTrade(way) {
  return request({
    url: 'trade/create',
    method: Method.POST,
    needToken: true,
 ...
 */
export function createAssembleTrade(client = 'WAP', pintuan_order_id = '') {
  return request({
    url: 'pintuan/trade',
    method: Method.POST,
    needToken: true,
 ...
 * @param coupon_id
 */
export function useCoupon(shop_id, mc_id, way) {
  return request({
    url: `trade/promotion/${shop_id}/seller/${mc_id}/coupon`,
    method: Method.POST,
    needToken: true,
    params: {
      way
