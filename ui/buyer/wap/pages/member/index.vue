  ...
  <div id="member-index" style="background-color: #f0f2f5">
    ...
    <div class="member-container">
      ...
      <div class="head-items">
        <div class="head-img">
          <nuxt-link to="/member/my-profile" v-if="user.face && user.face !== 'null'"><en-face :url="user.face"/></nuxt-link>
          <nuxt-link to="/member/my-profile" v-else><img src="../../assets/images/icon-noface.jpg"></nuxt-link>
        </div>
      ...
      <van-cell-group style="margin-top: 10px">
        <van-cell title="账户余额" is-link value="查看余额" to="/member/account-balance"/>
	      <van-cell title="我的发票" is-link value="查看发票" to="/member/my-receipt"/>
        <van-cell title="我的足迹" is-link value="查看足迹" to="/member/my-footprint"/>
        <van-cell title="优惠券" is-link value="查看优惠券" to="/member/my-coupons"/>
        <van-cell title="积分" is-link value="消费、等级积分" to="/member/my-points"/>
        <van-cell title="评论管理" is-link value="查看评论" to="/member/my-comments?order_status=WAIT_COMMENT"/>
        <van-cell title="咨询管理" is-link value="查看咨询" to="/member/my-ask"/>
        <van-cell title="站内消息" is-link value="查看站内消息" to="/member/message-index"/>
        <van-cell v-if="show_dis" title="分销管理" is-link value="查看我的分销" to="/member/distribution/distribution-manage"/>
        <van-cell title="交易投诉" is-link value="查看交易投诉" to="/member/my-complaint"/>
      </van-cell-group>
      <van-cell-group style="margin-top: 10px">
	      <van-cell title="增票资质" is-link value="申请增票资质" to="/member/increase-ticket"/>
        <van-cell title="个人信息" is-link value="修改资料" to="/member/my-profile"/>
