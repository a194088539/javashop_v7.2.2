<template>
  <div style="background: #f7f7f7">
    ...
    <div v-if="shopList && shopList.length" class="cart-container">
      <div class="shop-item" v-for="(shop, index) in shopList" :key="index">
        <div class="inner-shop-item">
          <div class="title-shop-item">
            ...
            <div class="shop-name">
              <nuxt-link :to="'/shop/' + shop.seller_id">{{ shop.seller_name }}</nuxt-link>
            </div>
          ...
          <div class="promotion-notice" v-if="shop.showPromotionNotice">{{ shop.promotion_notice }}</div>
              ...
              <van-swipe-cell :right-width="90">
                <div class="sku-item">
                  ...
                  <div class="sku-content">
                    <nuxt-link :to="'/goods/' + sku.goods_id" class="sku-name" v-html="sku.name">{{ sku.name }}</nuxt-link>
                    ...
                    <div class="sku-tools">
                      ...
                      <div v-if="sku.invalid !== 1" class="sku-num">
                        <a class="sku-symbol symbol-less minus unable" :class="[sku.num < 2 && 'disabled']" href="javascript:;" @click.stop="handleUpdateSkuNum(sku, '-')">-</a>
                        <input type="tel" class="sku-num-input" size="4" :value="sku.num" maxlength="8" @change="handleUpdateSkuNum(sku, $event)">
