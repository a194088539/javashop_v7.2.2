<template>
  <div class="ckt-item receipt">
    ...
    <div class="content-ckt receipt" v-if="isShowMembersReceip">
      <div v-if="!receipt|| !receipt.receipt_title || !price" class="item">无需发票</div>
      <template v-else>
      ...
      <a v-if="receipt && receipt.receipt_title && !price" href="javascript:" class="item cancel-btn" @click="handleCancelReceipt">取消发票</a>
    </div>
    <div class="content-ckt receipt" v-if="!isShowMembersReceip">
