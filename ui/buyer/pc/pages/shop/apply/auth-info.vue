    ...
    <div class="content">
      ...
      >
        ...
        <el-form-item label="法定经营范围：" prop="scope">
          <el-input v-model="authInfoForm.scope" :maxlength="100" clearable></el-input>
        </el-form-item>
  ...
  export default {
    ...
    mounted() {
      API_Shop.getApplyShopInfo().then(response => {
        ...
        response.licence_end = licence_end == 0 ? null : response.licence_end *= 1000;
        ...
        this.licence_img_file = this.authInfoForm.licence_img ? [{ name: 'licence_img', url: this.authInfoForm.licence_img }] : []
