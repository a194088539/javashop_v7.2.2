      ...
      <div class="shop-header-right">
        <div class="shop-nav">
          <div class="item category">
            <nuxt-link :to="'/shop/goods-list?shop_id=' + shop_id">
              <h3>全部分组</h3>
            </nuxt-link>
            <div class="category-box">
              <div class="inner-category-box">
                <div v-for="cate in categorys" :key="cate.shop_cat_id" class="category-item">
                  <nuxt-link :to="'/shop/goods-list?shop_id=' + shop_id + '&shop_cat_id=' + cate.shop_cat_id">{{ cate.shop_cat_name }}</nuxt-link>
                  <div class="category-item-box">
                    <template v-for="cc in cate.children">
                      ...
                      >
                        <nuxt-link :to="'/shop/goods-list?shop_id=' + shop_id + '&shop_cat_id=' + cc.shop_cat_id">{{ cc.shop_cat_name }}</nuxt-link>
                      </div>
                    </template>
                  </div>
                </div>
