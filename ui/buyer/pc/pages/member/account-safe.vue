  ...
  <div id="account-security">
    <div class="member-nav">
      <ul class="member-nav-list">
        <li class="active">
          <nuxt-link to="/member/account-safe" style="color:#f42424;">账户安全</nuxt-link>
        </li>
      </ul>
    </div>
    ...
    <div class="safe-item">
      ...
      <div class="fore3">
        <nuxt-link v-if="!user.mobile" to="/member/bind-mobile">绑定</nuxt-link>
        <nuxt-link v-if="user.mobile && !user.email" to="/member/bind-email">绑定</nuxt-link>
        <nuxt-link v-if="user.mobile && user.email" to="/member/bind-email">修改</nuxt-link>
      </div>
    </div>
    <div class="safe-item">
      ...
      <div class="fore3">
        <nuxt-link v-if="!isPassword" to="/member/change-paymentpassword">设置</nuxt-link>
        <nuxt-link v-else to="/member/change-paymentpassword">修改</nuxt-link>
      </div>
    </div>
  </div>
</template>
