        ...
        <div class="mc">
          <table class="tb-void tb-top">
            ...
            <tr v-for="refund in refundList.data" :key="refund.service_sn">
              <td align="center">
                <nuxt-link :to="'/member/service-detail?service_sn=' + refund.service_sn">{{ refund.service_sn }}</nuxt-link>
              </td>
              <td>
                <nuxt-link :to="'/member/my-order/detail?order_sn=' + refund.order_sn" >{{ refund.order_sn }}</nuxt-link>
              </td>
              ...
              <td>
                <nuxt-link :to="'/member/service-detail?service_sn=' + refund.service_sn">查看</nuxt-link>
              </td>
            </tr>
            </tbody>
          </table>
