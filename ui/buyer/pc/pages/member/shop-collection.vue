  ...
  <div id="my-collection">
    <div class="member-nav">
      <ul class="member-nav-list">
        <li class="active">
          <nuxt-link to="/member/shop-collection" style="color:#f42424;">收藏的店铺</nuxt-link>
        </li>
      </ul>
    </div>
            ...
            <li v-for="shop in shopData.data" :key="shop.shop_id" :class="['coll-s-item', shop.show_del_pop && 'del-pop-show']">
              <div class="shop-card">
                ...
                <div class="shop-card-main">
                  <a :href="'/shop/' + shop.shop_id" class="shop-name">{{ shop.shop_name }}</a>
              ...
              <div class="shop-content">
                <div class="shop-goods-box">
                  <div class="goods-tab clearfix">
                    <div class="tab-item">
                      <a :href="'/shop/goods-list?shop_id=' + shop.shop_id">店铺商品</a>
                    </div>
                  </div>
                  <a :href="'/shop/' + shop.shop_id" class="see-more">查看更多&gt;&gt;</a>
                </div>
                <no-ssr>
