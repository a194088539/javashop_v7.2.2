  ...
  <div id="my-receipt">
    <div class="member-nav">
      <ul class="member-nav-list">
        <li class="active">
          <nuxt-link to="/member/my-receipt" style="color:#f42424;">我的发票</nuxt-link>
        </li>
      </ul>
    </div>
              ...
              <div class="receipt-tbody-item">
                <div class="receipt-item-sku">
                  <div class="sku-item" v-for="sku in (receipt.goods_json ? JSON.parse(receipt.goods_json): [])" :key="sku.goods_id">
                    ...
                    <a :href="'/goods/' + sku.goods_id" target="_blank" v-html="sku.name">
                      {{sku.name}}
                    </a>
                ...
                <div class="receipt-item-operation">
                  <nuxt-link :to="'/member/my-receipt/detail?history_id=' + receipt.history_id">发票详情</nuxt-link>
                </div>
              </div>
            </li>
          </template>
