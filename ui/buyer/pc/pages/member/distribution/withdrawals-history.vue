  ...
  <div id="withdrawals-history">
    <div class="member-nav">
      <ul class="member-nav-list">
        <li><nuxt-link to="/member/distribution/withdrawals-history">提现记录</nuxt-link></li>
      </ul>
    </div>
    ...
    <el-dialog
      ...
      <div>
        <span>转帐备注：</span> <span> {{currentRow.transfer_remark }}</span>
      </div>
      <div>
