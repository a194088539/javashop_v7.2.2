      ...
      <div v-if="selectorData.selected_cat && selectorData.selected_cat.length" class="gl-bar-title">
        ...
        <template v-for="(cat, catIndex) in selectorData.selected_cat">
          ...
          <div :key="catIndex" class="gl-bar-item">
            <nuxt-link :to="'/goods?category=' + cat.value" class="gl-bar-trigger">
              <span>{{ cat.name }}</span>
            ...
            <div class="gl-bar-content">
              <ul class="clearfix">
                <li v-for="(cc, ccIndex) in cat.other_options" :key="ccIndex">
                  <nuxt-link class="int" :to="'/goods?category=' + cc.value">{{ cc.name }}</nuxt-link>
                </li>
              </ul>
            </div>
          </div>
          ...
          <dd>
            <div class="brand-list">
              ...
              >
                ...
                >
                  <nuxt-link :to="'/goods?' + selector_url('brand', brand.value)" :title="brand.name">
                    <img :src="brand.url" :alt="brand.name"/>{{ brand.name }}</nuxt-link>
                </li>
              </transition-group>
              <a
          ...
          <ul v-else class="list-ul clearfix">
            <li v-for="goods in goodsListData.data" :key="goods.goods_id">
              <div class="gl-item">
                ...
                <div class="gl-shop">
                  <span>
                    <nuxt-link :to="'/shop/' + goods.seller_id" :title="goods.seller_name">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      GET_GoodsSelector() {
        API_Goods.getGoodsSelector(this.$route.query).then(response => {
