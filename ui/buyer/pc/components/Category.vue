  ...
  >
    ...
    <div v-show="unfold" class="category-layer">
      <template v-for="(item, index) in $store.getters.categories">
        <div v-if="index < MAX_SHOW_NUM" :key="item.category_id" class="category-item">
          <div class="item-content">
            ...
            <div class="item-title">
              ...
              <template v-for="(_item, _index) in item.children">
                <nuxt-link v-if="_index < 2" :key="_item.catrgory_id" :to="'/goods?category=' + _item.category_id">{{ _item.name }}</nuxt-link>
              </template>
            </span>
            </div>
          </div>
              ...
              <div class="item-layer-left">
                ...
                <span>
                  <dl v-for="_item in item.children" :key="_item.category_id">
                    ...
                    <dd>
                      <nuxt-link v-for="__item in _item.children" :key="__item.category_id" :to="'/goods?category=' + __item.category_id">{{ __item.name }}</nuxt-link>
                    </dd>
                  </dl>
                </span>
