 ...
 * 预存款支付
 * @param sn  订单/交易编号
 * @param trade_type  订单/交易
 * @param password  密码
 * @returns {AxiosPromise<any>}
 */
export function balancePay(sn, trade_type, password) {
  return request({
 ...
 * @returns {AxiosPromise<any>}
 */
export function pinTuanAddCart(params) {
  return request({
 ...
 * 获取拼团购物列表
 */
export function getPinTuanCarts() {
  return request({
    url: 'pintuan/cart',
    method: Method.GET,
    needToken: true,
 ...
 * @returns {AxiosPromise<any>}
 */
export function pinTuanTrade(client_type = 'APP', pintuan_order_id) {
  return request({
    url: 'pintuan/trade',
    method: Method.POST,
    needToken: true,
 ...
 * @returns {AxiosPromise<any>}
 */
export function pinTuanOrder(goods_id,sku_id) {
  return request({
