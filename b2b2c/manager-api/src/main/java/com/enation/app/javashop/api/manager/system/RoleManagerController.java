...
public class RoleManagerController {
    ...
    @GetMapping
    public WebPage list(@ApiIgnore @NotEmpty(message = "页码不能为空") Long pageNo, @ApiIgnore @NotEmpty(message = "每页数量不能为空") Long pageSize, @ApiIgnore String keyword) {
    ...
    public RoleVO edit(@RequestBody @ApiIgnore RoleVO roleVO, @PathVariable Long id) {
